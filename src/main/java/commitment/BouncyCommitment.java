...
//		}
//
//		return Arrays.asList(this.value.getXCoord().toBigInteger(), this.value.getYCoord().toBigInteger());
//	}
//
...
//		return this.value.getXCoord().toBigInteger().add(this.value.getYCoord().toBigInteger());
//	}
//}
