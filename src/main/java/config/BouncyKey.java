...
//
//			// this.g = mapIntoBN128(BigInteger.valueOf(("G" +
//			// System.currentTimeMillis()).hashCode()), curve, this.q);
//			// this.h = mapIntoBN128(BigInteger.valueOf(("H" +
//			// System.currentTimeMillis()).hashCode()), curve, this.q);
//
//			break;
//		}
...
public class BouncyKey extends Key<ECPoint> {
	...
	public BouncyKey(String keyName) {
		switch (keyName) {
			case "bn128":
				// group G_1 is cyclic group of prime order q =
				this.n = new BigInteger("21888242871839275222246405745257275088548364400416034343698204186575808495617");

				// G_1 is defined on the curve Y^2 = x^3 + 3 over the field F_p with p =
				this.q = new BigInteger("21888242871839275222246405745257275088696311157297823662689037894645226208583");
...
//				System.out.println("validate point: " + curve.validatePoint(
//						new BigInteger(
//								"4046056476735720568578097190358221403130259959283330178145417420356195107066"),
//						new BigInteger(
//								"11080373612104581075220329149890284416182413148274529072717742316706231369826")));
